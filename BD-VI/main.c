...
double     *x1, theta, theta0, B, *b, *c, *cperim, Q;
double     MAX_DOUBLE = 10000000000;
double     MAX_DOUBLE2 = 10000000;
double     *xi, *p, *d, *alpha, *alpha1, *delta, *epsilon, *beta, *gamma1, *Delta1, obj;
...
double TimeLimitation = 1000* 60 * 60;
double checkTime;
...
void main(int argc, char *argv[])
{
	...
	for (numSample = 1; numSample < MaxNumInst; numSample++){
		...
		iter = 0;
		checkTime = 0;
		while (Q - theta >= 0.01 && checkTime < TimeLimitation){
